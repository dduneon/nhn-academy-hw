...
public class User {
  ...
  public User(String userId, String userName, String userPassword, String userBirth, Auth userAuth,
      int userPoint, LocalDateTime createdAt, LocalDateTime latestLoginAt) {
    this.userId = userId;
  ...
  public String getUserBirthYear() {
    return userBirth.substring(0, 4);
  }

  public String getUserBirthMonth() {
    return userBirth.substring(4, 6);
  }

  public String getUserBirthDay() {
    return userBirth.substring(6);
  }

  public String getUserBirthToDateFormat() {
    return getUserBirthYear() + "-" + getUserBirthMonth() + "-" + getUserBirthDay();
  }
