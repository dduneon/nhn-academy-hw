...
<div class="row row-cols-1 row-cols-sm-4 g-3">
    <c:forEach var="item" items="${requestScope.PAGE_CONTENTS.getContent()}">
        <div class="col">
            <!-- -->
            <a href="<c:url value="/detail/${item.getProductId()}"/>">
...
<nav aria-label="Page navigation" style="padding-top: 20px">
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item">
            ...
            <a class="page-link" href="?page=${requestScope.PAGE_CONTENTS.getCurrentIndex()-1}" tabindex="-1">Previous</a>
        </li>
        <!-- todo index Link 넣기(최대 아이템 10개 해놓고 이동하도록)-->
        <c:forEach var="item" begin="${requestScope.PAGE_CONTENTS.getStartPage()}" end="${requestScope.PAGE_CONTENTS.getEndPage()}">
            <c:choose>
        ...
        <li class="page-item">
            ...
            <a class="page-link" href="?page=${requestScope.PAGE_CONTENTS.getCurrentIndex()+1}" tabindex="-1">Next</a>
        </li>
    </ul>
</nav>
